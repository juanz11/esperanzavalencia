        ...
        <div class="bt-container-menu-full">
					<div class="bt-itable">
						...
						if (pll_current_language() == 'en')
        					echo '<a id="donate-btn-en" class="btn btn-primary btn-sm" href="https://sai.ngo/donate-now/" role="button">DONATE NOW</a>';													
    					else 
							echo '<a id="donate-btn-es"  class="btn btn-primary btn-sm" href="https://sai.ngo/es/donar-ahora/" role="button">DONAR AHORA</a>';						
						?>													
					</div>
