...
<div class="contenido_caja">
	<div class="contenedor">
		...
		<!-- inicio paginacion para miscomentarios-->
		<?php $numero_paginas = numero_paginas_por_comentarios($blog_config['post_por_pagina'], $conexion, $usuario); ?>
		...
		<div class="paginacion">
			<ul>
				...
				<?php else: ?>
					<li><a href="miscomentarios.php?p=<?php echo pagina_actual() -1 ?>">&laquo;</a></li>
				<?php endif; ?>
				...
				<?php for($i = 1; $i <= $numero_paginas; $i++): ?>
					...
					<?php else: ?>
						<li><a href="miscomentarios.php?p=<?php echo $i; ?>"><?php echo $i; ?></a></li>
					<?php endif; ?>
				<?php endfor; ?>
				...
				<?php else: ?>
					<li><a href="miscomentarios.php?p=<?php echo pagina_actual() + 1; ?>">&raquo;</a></li>
				<?php endif; ?>
			</ul>
		</div>
		<!-- fin paginacion para miscomentarios-->
	</div>
</div>
</div>
<script>
