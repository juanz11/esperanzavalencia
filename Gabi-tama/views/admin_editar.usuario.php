	...
	<div class="contenedor">
		...
		<div class="articulos admin_articulos">
			<div class="columna admin_colum nuevoa">
				...
				<?php
					if (isset($_GET['resul'])) {
						$resultado = ($_GET['resul']=='error')? "<h2 class='error'>Para cambiar de status de Administrador a Suscriptor debe agregar 2 o mas administradores</h2>" : "Cambiado a Suscriptor correctamente";
						echo $resultado;
					}
				...
				<form class="formulario" method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF']; ?>">
					...
					<input type="hidden" value="<?php echo $tengo['password']; ?>" name="password">
					<input type="text" name="password" value="<?php echo $tengo['password']; ?>" disabled>
					...
					<select name="status">
						...
						?></option>
						<option value="<?php echo $tengo['status']; ?>" class="blogsop"> -------- Cambiar a: ---------</option>
